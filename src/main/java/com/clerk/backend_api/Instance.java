...
public class Instance implements
    ...
    public UpdateInstanceAuthConfigResponse updateAuthConfig(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "402", "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ClerkErrors42 _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ClerkErrors42>() {});
                throw _out;
            } else {
                throw new SDKError(
                    _httpRes, 
    ...
    public UpdateProductionInstanceDomainResponse updateProductionDomain(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "400", "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ClerkErrors43 _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ClerkErrors43>() {});
                throw _out;
            } else {
                throw new SDKError(
                    _httpRes, 
    ...
    public UpdateInstanceResponse update(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ClerkErrors49 _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ClerkErrors49>() {});
                throw _out;
            } else {
                throw new SDKError(
                    _httpRes, 
    ...
    public ChangeProductionInstanceDomainResponse changeProductionDomain(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "400", "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ClerkErrors50 _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ClerkErrors50>() {});
                throw _out;
            } else {
                throw new SDKError(
                    _httpRes, 
    ...
    public UpdateInstanceOrganizationSettingsResponse updateOrganizationSettings(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "402", "404", "422")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                ClerkErrors51 _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<ClerkErrors51>() {});
                throw _out;
            } else {
                throw new SDKError(
                    _httpRes, 
