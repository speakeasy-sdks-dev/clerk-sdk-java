...
/**
 * ClerkErrors48 - Request was not successful
 */
public class ClerkErrors48 extends RuntimeException {
    ...
    public ClerkErrors48 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors48 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors48 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors48 other = (ClerkErrors48) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors48.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors48 build() {
            return new ClerkErrors48(
                errors,
                meta);
        }
    }
