...
/**
 * ClerkErrors24 - Invalid request parameters
 */
public class ClerkErrors24 extends RuntimeException {
    ...
    public ClerkErrors24 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors24 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors24 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors24 other = (ClerkErrors24) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors24.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors24 build() {
            return new ClerkErrors24(
                errors,
                meta);
        }
    }
