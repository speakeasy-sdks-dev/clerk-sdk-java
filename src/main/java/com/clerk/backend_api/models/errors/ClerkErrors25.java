...
/**
 * ClerkErrors25 - Request was not successful
 */
public class ClerkErrors25 extends RuntimeException {
    ...
    public ClerkErrors25 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors25 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors25 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors25 other = (ClerkErrors25) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors25.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors25 build() {
            return new ClerkErrors25(
                errors,
                meta);
        }
    }
