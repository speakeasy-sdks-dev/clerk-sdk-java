...
/**
 * ClerkErrors1 - Request was not successful
 */
public class ClerkErrors1 extends RuntimeException {
    ...
    public ClerkErrors1 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors1 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors1 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors1 other = (ClerkErrors1) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors1.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors1 build() {
            return new ClerkErrors1(
                errors,
                meta);
        }
    }
