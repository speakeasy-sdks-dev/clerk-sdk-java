...
/**
 * ClerkErrors35 - Request was not successful
 */
public class ClerkErrors35 extends RuntimeException {
    ...
    public ClerkErrors35 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors35 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors35 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors35 other = (ClerkErrors35) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors35.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors35 build() {
            return new ClerkErrors35(
                errors,
                meta);
        }
    }
