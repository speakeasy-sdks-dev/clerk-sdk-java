...
/**
 * ClerkErrors84 - Authorization invalid
 */
public class ClerkErrors84 extends RuntimeException {
    ...
    public ClerkErrors84 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors84 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors84 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors84 other = (ClerkErrors84) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors84.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors84 build() {
            return new ClerkErrors84(
                errors,
                meta);
        }
    }
