...
/**
 * ClerkErrors27 - Request was not successful
 */
public class ClerkErrors27 extends RuntimeException {
    ...
    public ClerkErrors27 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors27 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors27 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors27 other = (ClerkErrors27) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors27.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors27 build() {
            return new ClerkErrors27(
                errors,
                meta);
        }
    }
