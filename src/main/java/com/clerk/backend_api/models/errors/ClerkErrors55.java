...
/**
 * ClerkErrors55 - Request was not successful
 */
public class ClerkErrors55 extends RuntimeException {
    ...
    public ClerkErrors55 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors55 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors55 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors55 other = (ClerkErrors55) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors55.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors55 build() {
            return new ClerkErrors55(
                errors,
                meta);
        }
    }
