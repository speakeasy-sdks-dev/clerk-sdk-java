...
/**
 * ClerkErrors67 - Request was not successful
 */
public class ClerkErrors67 extends RuntimeException {
    ...
    public ClerkErrors67 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors67 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors67 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors67 other = (ClerkErrors67) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors67.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors67 build() {
            return new ClerkErrors67(
                errors,
                meta);
        }
    }
