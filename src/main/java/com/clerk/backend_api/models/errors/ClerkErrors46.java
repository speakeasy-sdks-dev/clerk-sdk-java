...
/**
 * ClerkErrors46 - Request was not successful
 */
public class ClerkErrors46 extends RuntimeException {
    ...
    public ClerkErrors46 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors46 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors46 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors46 other = (ClerkErrors46) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors46.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors46 build() {
            return new ClerkErrors46(
                errors,
                meta);
        }
    }
