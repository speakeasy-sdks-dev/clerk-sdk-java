...
/**
 * ClerkErrors51 - Payment required
 */
public class ClerkErrors51 extends RuntimeException {
    ...
    public ClerkErrors51 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors51 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors51 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors51 other = (ClerkErrors51) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors51.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors51 build() {
            return new ClerkErrors51(
                errors,
                meta);
        }
    }
