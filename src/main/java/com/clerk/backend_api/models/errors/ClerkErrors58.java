...
/**
 * ClerkErrors58 - Request was not successful
 */
public class ClerkErrors58 extends RuntimeException {
    ...
    public ClerkErrors58 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors58 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors58 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors58 other = (ClerkErrors58) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors58.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors58 build() {
            return new ClerkErrors58(
                errors,
                meta);
        }
    }
