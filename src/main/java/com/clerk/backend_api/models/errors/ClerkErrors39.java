...
/**
 * ClerkErrors39 - Authentication invalid
 */
public class ClerkErrors39 extends RuntimeException {
    ...
    public ClerkErrors39 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors39 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors39 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors39 other = (ClerkErrors39) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors39.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors39 build() {
            return new ClerkErrors39(
                errors,
                meta);
        }
    }
