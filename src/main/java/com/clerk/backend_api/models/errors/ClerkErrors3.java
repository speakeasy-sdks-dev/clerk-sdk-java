...
/**
 * ClerkErrors3 - Request was not successful
 */
public class ClerkErrors3 extends RuntimeException {
    ...
    public ClerkErrors3 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors3 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors3 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors3 other = (ClerkErrors3) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors3.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors3 build() {
            return new ClerkErrors3(
                errors,
                meta);
        }
    }
