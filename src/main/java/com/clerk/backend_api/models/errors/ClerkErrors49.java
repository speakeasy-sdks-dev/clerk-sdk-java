...
/**
 * ClerkErrors49 - Invalid request parameters
 */
public class ClerkErrors49 extends RuntimeException {
    ...
    public ClerkErrors49 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors49 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors49 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors49 other = (ClerkErrors49) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors49.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors49 build() {
            return new ClerkErrors49(
                errors,
                meta);
        }
    }
