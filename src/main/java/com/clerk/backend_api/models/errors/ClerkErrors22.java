...
/**
 * ClerkErrors22 - Request was not successful
 */
public class ClerkErrors22 extends RuntimeException {
    ...
    public ClerkErrors22 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors22 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors22 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors22 other = (ClerkErrors22) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors22.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors22 build() {
            return new ClerkErrors22(
                errors,
                meta);
        }
    }
