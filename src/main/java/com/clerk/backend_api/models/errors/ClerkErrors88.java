...
/**
 * ClerkErrors88 - Payment required
 */
public class ClerkErrors88 extends RuntimeException {
    ...
    public ClerkErrors88 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors88 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors88 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors88 other = (ClerkErrors88) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors88.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors88 build() {
            return new ClerkErrors88(
                errors,
                meta);
        }
    }
