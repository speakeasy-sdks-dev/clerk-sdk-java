...
/**
 * ClerkErrors79 - Authorization invalid
 */
public class ClerkErrors79 extends RuntimeException {
    ...
    public ClerkErrors79 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors79 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors79 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors79 other = (ClerkErrors79) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors79.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors79 build() {
            return new ClerkErrors79(
                errors,
                meta);
        }
    }
