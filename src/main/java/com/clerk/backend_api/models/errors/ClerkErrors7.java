...
/**
 * ClerkErrors7 - Request was not successful
 */
public class ClerkErrors7 extends RuntimeException {
    ...
    public ClerkErrors7 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors7 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors7 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors7 other = (ClerkErrors7) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors7.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors7 build() {
            return new ClerkErrors7(
                errors,
                meta);
        }
    }
