...
/**
 * ClerkErrors71 - Request was not successful
 */
public class ClerkErrors71 extends RuntimeException {
    ...
    public ClerkErrors71 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors71 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors71 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors71 other = (ClerkErrors71) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors71.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors71 build() {
            return new ClerkErrors71(
                errors,
                meta);
        }
    }
