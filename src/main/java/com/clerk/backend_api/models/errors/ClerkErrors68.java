...
/**
 * ClerkErrors68 - Request was not successful
 */
public class ClerkErrors68 extends RuntimeException {
    ...
    public ClerkErrors68 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors68 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors68 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors68 other = (ClerkErrors68) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors68.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors68 build() {
            return new ClerkErrors68(
                errors,
                meta);
        }
    }
