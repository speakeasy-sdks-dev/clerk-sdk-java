...
/**
 * ClerkErrors83 - Authorization invalid
 */
public class ClerkErrors83 extends RuntimeException {
    ...
    public ClerkErrors83 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors83 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors83 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors83 other = (ClerkErrors83) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors83.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors83 build() {
            return new ClerkErrors83(
                errors,
                meta);
        }
    }
