...
/**
 * ClerkErrors18 - Request was not successful
 */
public class ClerkErrors18 extends RuntimeException {
    ...
    public ClerkErrors18 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors18 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors18 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors18 other = (ClerkErrors18) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors18.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors18 build() {
            return new ClerkErrors18(
                errors,
                meta);
        }
    }
