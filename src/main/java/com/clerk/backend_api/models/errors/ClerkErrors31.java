...
/**
 * ClerkErrors31 - Request was not successful
 */
public class ClerkErrors31 extends RuntimeException {
    ...
    public ClerkErrors31 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors31 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors31 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors31 other = (ClerkErrors31) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors31.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors31 build() {
            return new ClerkErrors31(
                errors,
                meta);
        }
    }
