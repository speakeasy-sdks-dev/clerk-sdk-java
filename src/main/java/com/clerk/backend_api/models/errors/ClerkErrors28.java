...
/**
 * ClerkErrors28 - Payment required
 */
public class ClerkErrors28 extends RuntimeException {
    ...
    public ClerkErrors28 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors28 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors28 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors28 other = (ClerkErrors28) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors28.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors28 build() {
            return new ClerkErrors28(
                errors,
                meta);
        }
    }
