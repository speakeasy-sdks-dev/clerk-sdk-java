...
/**
 * ClerkErrors60 - Resource not found
 */
public class ClerkErrors60 extends RuntimeException {
    ...
    public ClerkErrors60 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors60 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors60 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors60 other = (ClerkErrors60) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors60.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors60 build() {
            return new ClerkErrors60(
                errors,
                meta);
        }
    }
