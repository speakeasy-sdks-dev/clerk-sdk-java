...
/**
 * ClerkErrors17 - Request was not successful
 */
public class ClerkErrors17 extends RuntimeException {
    ...
    public ClerkErrors17 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors17 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors17 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors17 other = (ClerkErrors17) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors17.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors17 build() {
            return new ClerkErrors17(
                errors,
                meta);
        }
    }
