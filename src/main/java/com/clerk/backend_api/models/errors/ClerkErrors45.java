...
/**
 * ClerkErrors45 - Request was not successful
 */
public class ClerkErrors45 extends RuntimeException {
    ...
    public ClerkErrors45 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors45 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors45 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors45 other = (ClerkErrors45) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors45.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors45 build() {
            return new ClerkErrors45(
                errors,
                meta);
        }
    }
