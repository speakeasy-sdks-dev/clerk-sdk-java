 ...
 */
public class ClerkErrors41 extends RuntimeException {
    ...
    public ClerkErrors41 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors41 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors41 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors41 other = (ClerkErrors41) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors41.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors41 build() {
            return new ClerkErrors41(
                errors,
                meta);
        }
    }
