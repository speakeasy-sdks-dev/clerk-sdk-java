...
/**
 * ClerkErrors44 - Request was not successful
 */
public class ClerkErrors44 extends RuntimeException {
    ...
    public ClerkErrors44 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors44 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors44 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors44 other = (ClerkErrors44) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors44.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors44 build() {
            return new ClerkErrors44(
                errors,
                meta);
        }
    }
