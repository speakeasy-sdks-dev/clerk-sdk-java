...
/**
 * ClerkErrors4 - Request was not successful
 */
public class ClerkErrors4 extends RuntimeException {
    ...
    public ClerkErrors4 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors4 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors4 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors4 other = (ClerkErrors4) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors4.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors4 build() {
            return new ClerkErrors4(
                errors,
                meta);
        }
    }
