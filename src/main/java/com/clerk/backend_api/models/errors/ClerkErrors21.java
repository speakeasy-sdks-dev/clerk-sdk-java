...
/**
 * ClerkErrors21 - Request was not successful
 */
public class ClerkErrors21 extends RuntimeException {
    ...
    public ClerkErrors21 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors21 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors21 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors21 other = (ClerkErrors21) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors21.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors21 build() {
            return new ClerkErrors21(
                errors,
                meta);
        }
    }
