...
/**
 * ClerkErrors75 - Request was not successful
 */
public class ClerkErrors75 extends RuntimeException {
    ...
    public ClerkErrors75 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors75 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors75 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors75 other = (ClerkErrors75) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors75.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors75 build() {
            return new ClerkErrors75(
                errors,
                meta);
        }
    }
