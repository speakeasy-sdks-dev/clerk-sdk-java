...
/**
 * ClerkErrors74 - Request was not successful
 */
public class ClerkErrors74 extends RuntimeException {
    ...
    public ClerkErrors74 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors74 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors74 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors74 other = (ClerkErrors74) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors74.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors74 build() {
            return new ClerkErrors74(
                errors,
                meta);
        }
    }
