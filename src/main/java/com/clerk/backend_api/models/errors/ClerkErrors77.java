...
/**
 * ClerkErrors77 - Resource not found
 */
public class ClerkErrors77 extends RuntimeException {
    ...
    public ClerkErrors77 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors77 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors77 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors77 other = (ClerkErrors77) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors77.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors77 build() {
            return new ClerkErrors77(
                errors,
                meta);
        }
    }
