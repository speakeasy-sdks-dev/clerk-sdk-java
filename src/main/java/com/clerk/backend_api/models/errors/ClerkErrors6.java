...
/**
 * ClerkErrors6 - Request was not successful
 */
public class ClerkErrors6 extends RuntimeException {
    ...
    public ClerkErrors6 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors6 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors6 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors6 other = (ClerkErrors6) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors6.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors6 build() {
            return new ClerkErrors6(
                errors,
                meta);
        }
    }
