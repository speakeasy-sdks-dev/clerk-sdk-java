...
/**
 * ClerkErrors40 - Request was not successful
 */
public class ClerkErrors40 extends RuntimeException {
    ...
    public ClerkErrors40 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors40 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors40 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors40 other = (ClerkErrors40) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors40.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors40 build() {
            return new ClerkErrors40(
                errors,
                meta);
        }
    }
