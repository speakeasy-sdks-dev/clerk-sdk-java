...
/**
 * ClerkErrors78 - Request was not successful
 */
public class ClerkErrors78 extends RuntimeException {
    ...
    public ClerkErrors78 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors78 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors78 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors78 other = (ClerkErrors78) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors78.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors78 build() {
            return new ClerkErrors78(
                errors,
                meta);
        }
    }
