...
/**
 * ClerkErrors30 - Request was not successful
 */
public class ClerkErrors30 extends RuntimeException {
    ...
    public ClerkErrors30 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors30 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors30 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors30 other = (ClerkErrors30) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors30.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors30 build() {
            return new ClerkErrors30(
                errors,
                meta);
        }
    }
