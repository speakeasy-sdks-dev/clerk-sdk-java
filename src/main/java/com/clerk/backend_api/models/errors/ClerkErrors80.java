...
/**
 * ClerkErrors80 - Request was not successful
 */
public class ClerkErrors80 extends RuntimeException {
    ...
    public ClerkErrors80 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors80 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors80 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors80 other = (ClerkErrors80) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors80.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors80 build() {
            return new ClerkErrors80(
                errors,
                meta);
        }
    }
