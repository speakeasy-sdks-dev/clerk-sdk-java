...
/**
 * ClerkErrors10 - Request was not successful
 */
public class ClerkErrors10 extends RuntimeException {
    ...
    public ClerkErrors10 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors10 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors10 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors10 other = (ClerkErrors10) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors10.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors10 build() {
            return new ClerkErrors10(
                errors,
                meta);
        }
    }
