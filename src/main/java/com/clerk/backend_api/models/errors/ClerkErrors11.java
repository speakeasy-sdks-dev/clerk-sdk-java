...
/**
 * ClerkErrors11 - Request was not successful
 */
public class ClerkErrors11 extends RuntimeException {
    ...
    public ClerkErrors11 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors11 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors11 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors11 other = (ClerkErrors11) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors11.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors11 build() {
            return new ClerkErrors11(
                errors,
                meta);
        }
    }
