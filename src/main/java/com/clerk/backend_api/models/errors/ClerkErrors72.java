...
/**
 * ClerkErrors72 - Request was not successful
 */
public class ClerkErrors72 extends RuntimeException {
    ...
    public ClerkErrors72 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors72 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors72 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors72 other = (ClerkErrors72) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors72.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors72 build() {
            return new ClerkErrors72(
                errors,
                meta);
        }
    }
