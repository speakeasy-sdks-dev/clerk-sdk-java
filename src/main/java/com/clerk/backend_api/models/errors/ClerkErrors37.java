...
/**
 * ClerkErrors37 - Request was not successful
 */
public class ClerkErrors37 extends RuntimeException {
    ...
    public ClerkErrors37 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors37 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors37 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors37 other = (ClerkErrors37) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors37.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors37 build() {
            return new ClerkErrors37(
                errors,
                meta);
        }
    }
