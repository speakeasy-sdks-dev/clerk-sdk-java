...
/**
 * ClerkErrors29 - Payment required
 */
public class ClerkErrors29 extends RuntimeException {
    ...
    public ClerkErrors29 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors29 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors29 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors29 other = (ClerkErrors29) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors29.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors29 build() {
            return new ClerkErrors29(
                errors,
                meta);
        }
    }
