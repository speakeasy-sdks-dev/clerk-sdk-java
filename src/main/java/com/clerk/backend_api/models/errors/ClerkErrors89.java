...
/**
 * ClerkErrors89 - Payment required
 */
public class ClerkErrors89 extends RuntimeException {
    ...
    public ClerkErrors89 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors89 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors89 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors89 other = (ClerkErrors89) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors89.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors89 build() {
            return new ClerkErrors89(
                errors,
                meta);
        }
    }
