...
/**
 * ClerkErrors82 - Authorization invalid
 */
public class ClerkErrors82 extends RuntimeException {
    ...
    public ClerkErrors82 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors82 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors82 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors82 other = (ClerkErrors82) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors82.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors82 build() {
            return new ClerkErrors82(
                errors,
                meta);
        }
    }
