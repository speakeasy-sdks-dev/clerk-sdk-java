...
/**
 * ClerkErrors12 - Request was not successful
 */
public class ClerkErrors12 extends RuntimeException {
    ...
    public ClerkErrors12 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors12 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors12 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors12 other = (ClerkErrors12) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors12.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors12 build() {
            return new ClerkErrors12(
                errors,
                meta);
        }
    }
