...
/**
 * ClerkErrors13 - Request was not successful
 */
public class ClerkErrors13 extends RuntimeException {
    ...
    public ClerkErrors13 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors13 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors13 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors13 other = (ClerkErrors13) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors13.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors13 build() {
            return new ClerkErrors13(
                errors,
                meta);
        }
    }
