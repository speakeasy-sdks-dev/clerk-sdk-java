 ...
 */
public class ClerkErrors33 extends RuntimeException {
    ...
    public ClerkErrors33 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors33 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors33 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors33 other = (ClerkErrors33) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors33.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors33 build() {
            return new ClerkErrors33(
                errors,
                meta);
        }
    }
