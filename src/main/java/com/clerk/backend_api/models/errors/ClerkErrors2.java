...
/**
 * ClerkErrors2 - Request was not successful
 */
public class ClerkErrors2 extends RuntimeException {
    ...
    public ClerkErrors2 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors2 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors2 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors2 other = (ClerkErrors2) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors2.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors2 build() {
            return new ClerkErrors2(
                errors,
                meta);
        }
    }
