 ...
 */
public class ClerkErrors73 extends RuntimeException {
    ...
    public ClerkErrors73 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors73 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors73 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors73 other = (ClerkErrors73) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors73.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors73 build() {
            return new ClerkErrors73(
                errors,
                meta);
        }
    }
