...
/**
 * ClerkErrors52 - Request was not successful
 */
public class ClerkErrors52 extends RuntimeException {
    ...
    public ClerkErrors52 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors52 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors52 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors52 other = (ClerkErrors52) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors52.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors52 build() {
            return new ClerkErrors52(
                errors,
                meta);
        }
    }
