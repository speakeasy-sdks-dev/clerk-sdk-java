...
/**
 * ClerkErrors63 - Resource not found
 */
public class ClerkErrors63 extends RuntimeException {
    ...
    public ClerkErrors63 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors63 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors63 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors63 other = (ClerkErrors63) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors63.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors63 build() {
            return new ClerkErrors63(
                errors,
                meta);
        }
    }
