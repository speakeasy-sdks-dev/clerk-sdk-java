...
/**
 * ClerkErrors54 - Resource not found
 */
public class ClerkErrors54 extends RuntimeException {
    ...
    public ClerkErrors54 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors54 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors54 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors54 other = (ClerkErrors54) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors54.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors54 build() {
            return new ClerkErrors54(
                errors,
                meta);
        }
    }
