...
/**
 * ClerkErrors70 - Authentication invalid
 */
public class ClerkErrors70 extends RuntimeException {
    ...
    public ClerkErrors70 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors70 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors70 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors70 other = (ClerkErrors70) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors70.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors70 build() {
            return new ClerkErrors70(
                errors,
                meta);
        }
    }
