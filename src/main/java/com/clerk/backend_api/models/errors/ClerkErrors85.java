...
/**
 * ClerkErrors85 - Payment required
 */
public class ClerkErrors85 extends RuntimeException {
    ...
    public ClerkErrors85 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors85 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors85 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors85 other = (ClerkErrors85) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors85.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors85 build() {
            return new ClerkErrors85(
                errors,
                meta);
        }
    }
