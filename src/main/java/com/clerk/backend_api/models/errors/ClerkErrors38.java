 ...
 */
public class ClerkErrors38 extends RuntimeException {
    ...
    public ClerkErrors38 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors38 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors38 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors38 other = (ClerkErrors38) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors38.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors38 build() {
            return new ClerkErrors38(
                errors,
                meta);
        }
    }
