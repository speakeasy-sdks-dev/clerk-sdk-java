...
/**
 * ClerkErrors34 - Request was not successful
 */
public class ClerkErrors34 extends RuntimeException {
    ...
    public ClerkErrors34 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors34 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors34 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors34 other = (ClerkErrors34) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors34.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors34 build() {
            return new ClerkErrors34(
                errors,
                meta);
        }
    }
