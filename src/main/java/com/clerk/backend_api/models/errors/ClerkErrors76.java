...
/**
 * ClerkErrors76 - Resource not found
 */
public class ClerkErrors76 extends RuntimeException {
    ...
    public ClerkErrors76 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors76 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors76 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors76 other = (ClerkErrors76) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors76.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors76 build() {
            return new ClerkErrors76(
                errors,
                meta);
        }
    }
