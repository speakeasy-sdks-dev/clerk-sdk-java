 ...
 */
public class ClerkErrors66 extends RuntimeException {
    ...
    public ClerkErrors66 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors66 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors66 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors66 other = (ClerkErrors66) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors66.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors66 build() {
            return new ClerkErrors66(
                errors,
                meta);
        }
    }
