...
/**
 * ClerkErrors86 - Payment required
 */
public class ClerkErrors86 extends RuntimeException {
    ...
    public ClerkErrors86 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors86 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors86 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors86 other = (ClerkErrors86) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors86.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors86 build() {
            return new ClerkErrors86(
                errors,
                meta);
        }
    }
