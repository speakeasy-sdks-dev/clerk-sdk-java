...
/**
 * ClerkErrors16 - Request was not successful
 */
public class ClerkErrors16 extends RuntimeException {
    ...
    public ClerkErrors16 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors16 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors16 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors16 other = (ClerkErrors16) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors16.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors16 build() {
            return new ClerkErrors16(
                errors,
                meta);
        }
    }
