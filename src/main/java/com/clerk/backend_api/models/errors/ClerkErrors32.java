...
/**
 * ClerkErrors32 - Invalid request parameters
 */
public class ClerkErrors32 extends RuntimeException {
    ...
    public ClerkErrors32 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors32 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors32 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors32 other = (ClerkErrors32) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors32.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors32 build() {
            return new ClerkErrors32(
                errors,
                meta);
        }
    }
