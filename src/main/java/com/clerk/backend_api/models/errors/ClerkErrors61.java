...
/**
 * ClerkErrors61 - Resource not found
 */
public class ClerkErrors61 extends RuntimeException {
    ...
    public ClerkErrors61 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors61 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors61 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors61 other = (ClerkErrors61) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors61.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors61 build() {
            return new ClerkErrors61(
                errors,
                meta);
        }
    }
