...
/**
 * ClerkErrors56 - Authorization invalid
 */
public class ClerkErrors56 extends RuntimeException {
    ...
    public ClerkErrors56 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors56 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors56 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors56 other = (ClerkErrors56) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors56.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors56 build() {
            return new ClerkErrors56(
                errors,
                meta);
        }
    }
