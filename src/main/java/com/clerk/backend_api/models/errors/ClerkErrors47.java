...
/**
 * ClerkErrors47 - Request was not successful
 */
public class ClerkErrors47 extends RuntimeException {
    ...
    public ClerkErrors47 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors47 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors47 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors47 other = (ClerkErrors47) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors47.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors47 build() {
            return new ClerkErrors47(
                errors,
                meta);
        }
    }
