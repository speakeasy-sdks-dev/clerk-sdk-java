...
/**
 * ClerkErrors14 - Request was not successful
 */
public class ClerkErrors14 extends RuntimeException {
    ...
    public ClerkErrors14 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors14 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors14 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors14 other = (ClerkErrors14) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors14.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors14 build() {
            return new ClerkErrors14(
                errors,
                meta);
        }
    }
