...
/**
 * ClerkErrors64 - Request was not successful
 */
public class ClerkErrors64 extends RuntimeException {
    ...
    public ClerkErrors64 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors64 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors64 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors64 other = (ClerkErrors64) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors64.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors64 build() {
            return new ClerkErrors64(
                errors,
                meta);
        }
    }
