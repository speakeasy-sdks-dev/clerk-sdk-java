...
/**
 * ClerkErrors8 - Request was not successful
 */
public class ClerkErrors8 extends RuntimeException {
    ...
    public ClerkErrors8 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors8 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors8 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors8 other = (ClerkErrors8) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors8.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors8 build() {
            return new ClerkErrors8(
                errors,
                meta);
        }
    }
