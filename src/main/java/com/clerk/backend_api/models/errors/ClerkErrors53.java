...
/**
 * ClerkErrors53 - Request was not successful
 */
public class ClerkErrors53 extends RuntimeException {
    ...
    public ClerkErrors53 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors53 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors53 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors53 other = (ClerkErrors53) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors53.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors53 build() {
            return new ClerkErrors53(
                errors,
                meta);
        }
    }
