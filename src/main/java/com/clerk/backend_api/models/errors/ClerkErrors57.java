...
/**
 * ClerkErrors57 - Request was not successful
 */
public class ClerkErrors57 extends RuntimeException {
    ...
    public ClerkErrors57 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors57 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors57 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors57 other = (ClerkErrors57) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors57.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors57 build() {
            return new ClerkErrors57(
                errors,
                meta);
        }
    }
