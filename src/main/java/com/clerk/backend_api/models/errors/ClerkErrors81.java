...
/**
 * ClerkErrors81 - Authorization invalid
 */
public class ClerkErrors81 extends RuntimeException {
    ...
    public ClerkErrors81 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors81 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors81 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors81 other = (ClerkErrors81) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors81.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors81 build() {
            return new ClerkErrors81(
                errors,
                meta);
        }
    }
