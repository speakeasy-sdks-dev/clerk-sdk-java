...
/**
 * ClerkErrors26 - Request was not successful
 */
public class ClerkErrors26 extends RuntimeException {
    ...
    public ClerkErrors26 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors26 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors26 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors26 other = (ClerkErrors26) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors26.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors26 build() {
            return new ClerkErrors26(
                errors,
                meta);
        }
    }
