...
/**
 * ClerkErrors65 - Request was not successful
 */
public class ClerkErrors65 extends RuntimeException {
    ...
    public ClerkErrors65 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors65 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors65 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors65 other = (ClerkErrors65) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors65.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors65 build() {
            return new ClerkErrors65(
                errors,
                meta);
        }
    }
