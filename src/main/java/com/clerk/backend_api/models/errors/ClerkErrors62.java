...
/**
 * ClerkErrors62 - Request was not successful
 */
public class ClerkErrors62 extends RuntimeException {
    ...
    public ClerkErrors62 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors62 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors62 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors62 other = (ClerkErrors62) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors62.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors62 build() {
            return new ClerkErrors62(
                errors,
                meta);
        }
    }
