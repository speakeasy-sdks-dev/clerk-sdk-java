 ...
 */
public class ClerkErrors50 extends RuntimeException {
    ...
    public ClerkErrors50 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors50 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors50 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors50 other = (ClerkErrors50) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors50.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors50 build() {
            return new ClerkErrors50(
                errors,
                meta);
        }
    }
