...
/**
 * ClerkErrors9 - Request was not successful
 */
public class ClerkErrors9 extends RuntimeException {
    ...
    public ClerkErrors9 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors9 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors9 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors9 other = (ClerkErrors9) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors9.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors9 build() {
            return new ClerkErrors9(
                errors,
                meta);
        }
    }
