...
/**
 * ClerkErrors19 - Request was not successful
 */
public class ClerkErrors19 extends RuntimeException {
    ...
    public ClerkErrors19 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors19 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors19 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors19 other = (ClerkErrors19) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors19.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors19 build() {
            return new ClerkErrors19(
                errors,
                meta);
        }
    }
