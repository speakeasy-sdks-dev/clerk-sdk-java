...
/**
 * ClerkErrors23 - Request was not successful
 */
public class ClerkErrors23 extends RuntimeException {
    ...
    public ClerkErrors23 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors23 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors23 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors23 other = (ClerkErrors23) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors23.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors23 build() {
            return new ClerkErrors23(
                errors,
                meta);
        }
    }
