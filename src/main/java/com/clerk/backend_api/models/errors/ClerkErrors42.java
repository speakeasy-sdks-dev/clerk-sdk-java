...
/**
 * ClerkErrors42 - Payment required
 */
public class ClerkErrors42 extends RuntimeException {
    ...
    public ClerkErrors42 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors42 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors42 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors42 other = (ClerkErrors42) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors42.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors42 build() {
            return new ClerkErrors42(
                errors,
                meta);
        }
    }
