...
/**
 * ClerkErrors5 - Request was not successful
 */
public class ClerkErrors5 extends RuntimeException {
    ...
    public ClerkErrors5 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors5 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors5 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors5 other = (ClerkErrors5) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors5.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors5 build() {
            return new ClerkErrors5(
                errors,
                meta);
        }
    }
