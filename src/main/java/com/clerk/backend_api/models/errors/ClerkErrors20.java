...
/**
 * ClerkErrors20 - Request was not successful
 */
public class ClerkErrors20 extends RuntimeException {
    ...
    public ClerkErrors20 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors20 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors20 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors20 other = (ClerkErrors20) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors20.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors20 build() {
            return new ClerkErrors20(
                errors,
                meta);
        }
    }
