...
/**
 * ClerkErrors15 - Authentication invalid
 */
public class ClerkErrors15 extends RuntimeException {
    ...
    public ClerkErrors15 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors15 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors15 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors15 other = (ClerkErrors15) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors15.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors15 build() {
            return new ClerkErrors15(
                errors,
                meta);
        }
    }
