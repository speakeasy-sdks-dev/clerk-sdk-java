...
/**
 * ClerkErrors43 - Request was not successful
 */
public class ClerkErrors43 extends RuntimeException {
    ...
    public ClerkErrors43 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors43 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors43 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors43 other = (ClerkErrors43) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors43.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors43 build() {
            return new ClerkErrors43(
                errors,
                meta);
        }
    }
