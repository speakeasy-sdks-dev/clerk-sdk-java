...
/**
 * ClerkErrors36 - Authentication invalid
 */
public class ClerkErrors36 extends RuntimeException {
    ...
    public ClerkErrors36 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors36 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors36 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors36 other = (ClerkErrors36) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors36.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors36 build() {
            return new ClerkErrors36(
                errors,
                meta);
        }
    }
