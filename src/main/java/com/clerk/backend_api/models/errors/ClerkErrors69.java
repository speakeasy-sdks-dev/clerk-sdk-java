...
/**
 * ClerkErrors69 - Request was not successful
 */
public class ClerkErrors69 extends RuntimeException {
    ...
    public ClerkErrors69 withErrors(List<ClerkError> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }

    public ClerkErrors69 withMeta(Meta meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = Optional.ofNullable(meta);
        return this;
    }
    
    public ClerkErrors69 withMeta(Optional<? extends Meta> meta) {
        Utils.checkNotNull(meta, "meta");
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClerkErrors69 other = (ClerkErrors69) o;
        return
    ...
    public String toString() {
        return Utils.toString(ClerkErrors69.class,
                "errors", errors,
                "meta", meta);
    }
    ...
    public final static class Builder {
        ...
        public ClerkErrors69 build() {
            return new ClerkErrors69(
                errors,
                meta);
        }
    }
