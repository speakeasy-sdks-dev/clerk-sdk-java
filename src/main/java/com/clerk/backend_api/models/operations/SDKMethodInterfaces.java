...
public class SDKMethodInterfaces {
    ...
    public interface MethodCallGetJWKS {
        GetJWKSResponse getJWKSDirect() throws Exception;
    }
    ...
    public interface MethodCallToggleTemplateDelivery {
        ToggleTemplateDeliveryResponse toggleDelivery(
    ...
    public interface MethodCallListAllowlistIdentifiers {
        ListAllowlistIdentifiersResponse listDirect() throws Exception;
    }
    ...
    public interface MethodCallUpdateInstanceAuthConfig {
        UpdateInstanceAuthConfigResponse updateAuthConfig(
    ...
    public interface MethodCallUpdateProductionInstanceDomain {
        UpdateProductionInstanceDomainResponse updateProductionDomain(
    ...
    public interface MethodCallChangeProductionInstanceDomain {
        ChangeProductionInstanceDomainResponse changeProductionDomain(
    ...
    public interface MethodCallCreateOrganizationInvitationBulk {
        CreateOrganizationInvitationBulkResponse createBulk(
            String organizationId,
    ...
    public interface MethodCallVerifyDomainProxy {
        VerifyDomainProxyResponse verifyDomain(
    ...
    public interface MethodCallUpdateOAuthApplication {
        UpdateOAuthApplicationResponse updateApplication(
